...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        url_d = "https://01049230.eu-de.apigw.appdomain.cloud/api/dealership?dealerId={dealer_id}"
        url_r = "https://01049230.eu-de.apigw.appdomain.cloud/api/reviews?dealerId={dealer_id}"
        # Get dealers from the URL
        context = {
            "dealer": get_dealers_from_cf(url_d, dealer_Id),
...
def get_dealer_id(request,dealer_id):
    print(request)
    if request.method == "GET":
        url = "https://01049230.eu-de.apigw.appdomain.cloud/api/review"
